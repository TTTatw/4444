...
export const WorkflowToolbar: React.FC<Props> = ({ onLoad, onOpenLibrary, onOpenHistory, onOpenApiKeyModal, onOpenAuthModal, currentUser, onLogout, zoom, onZoomChange }) => {

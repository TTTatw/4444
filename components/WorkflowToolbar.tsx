...
const KeyIcon = () => (<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 11a5 5 0 1 1 9.9 1" /><path d="m10 11 2 2 4-4" /><path d="M10 11v5h5" /></svg>);

export const WorkflowToolbar: React.FC<Props> = ({ onLoad, onOpenLibrary, onOpenApiKeyModal }) => {

...
export const LoginPage: React.FC<LoginPageProps> = ({ onLogin }) => {
    ...
    return (
        <div className="fixed inset-0 bg-[#050505] overflow-hidden flex items-center justify-center font-sans text-slate-200 selection:bg-neon-blue/30">
            ...
            {/* Main Card */}
            <div
                className="relative z-10 w-full max-w-md p-8 rounded-3xl bg-black/40 backdrop-blur-xl border border-white/10 shadow-[0_0_50px_-10px_rgba(0,0,0,0.5)] transition-all duration-500 hover:shadow-[0_0_70px_-10px_rgba(60,20,150,0.3)] hover:border-white/20"
                style={{ transform: `translate(${mousePosition.x}px, ${mousePosition.y}px)` }}
            >
                {/* Header */}
                <div className="text-center mb-10">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-purple-600 mb-6 shadow-lg shadow-blue-500/20 animate-float">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white"><path d="M12 2a10 10 0 1 0 10 10 4 4 0 0 1-5-5 4 4 0 0 1-5-5" /><path d="M8.5 8.5v.01" /><path d="M16 15.5v.01" /><path d="M12 12v.01" /><path d="M8.5 15.5v.01" /><path d="M15.5 8.5v.01" /></svg>
                    </div>
                    <h1 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white via-slate-200 to-slate-400 tracking-tight mb-2">
                        Nexus AI
                    </h1>
                    <p className="text-slate-500 text-sm font-medium tracking-wide uppercase">Enterprise Workflow Engine</p>
                </div>
